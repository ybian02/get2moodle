...
//create a stack
var stack = Composites.stack(6, 3, 35, 2, 0, 0, function(x, y, column, row) {
  
 if (Math.random() > 0.35) {
    return Bodies.rectangle(x, y, 20, 340, {
      render: {   
         fillStyle: "#4285F4",
         strokeStyle: "#4285F4",
         lineWidth: 3,
    ...
    return Bodies.rectangle(x, y, 40, 600,  {
      render: {         
         fillStyle: "#F4B400",
         strokeStyle: "#F4B400",
         lineWidth: 3,
    ...
    return Bodies.rectangle(x, y, 300, 40, {
      density: 0.0005,
      frictionAir: 0.06,
      restitution: 0.3,
      friction: 0.06,
